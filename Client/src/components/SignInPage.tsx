...
const SignInPage: React.FC = () => {
  return (
    <div
      ...
      style={{
        backgroundImage:
          "linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.85)), url('https://static.vecteezy.com/system/resources/thumbnails/029/895/331/small_2x/music-symbol-above-the-sheet-background-free-photo.jpg')",
    ...
    >
      ...
      <div className="text-center mb-10">
        ...
        <p className="text-gray-300 text-lg mt-3">
          Sign in to access AI-powered Indian Classical Music tools
        </p>
      </div>
